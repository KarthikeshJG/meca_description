...
def generate_launch_description():
    ...
    pkg_meca_description = FindPackageShare('meca_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_meca_description, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the meca_description package
